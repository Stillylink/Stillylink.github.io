 ...
 * Поведение как в VK/Facebook:
 * - Колонка скроллится обычно вместе со страницей
 * - Когда низ колонки достигает низа экрана → она "прилипает" снизу
 * - Когда верх колонки достигает верха экрана → она "прилипает" сверху
 */
